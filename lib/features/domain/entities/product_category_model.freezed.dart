...
class _$ProductCategoryImpl implements _ProductCategory {
  ...
  @override
  String toString() {
    return 'ProductCategory(success: $success, data: $data, error: $error)';
  }
...
class _$DatumImpl implements _Datum {
  ...
  @override
  String toString() {
    return 'Datum(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, nameUz: $nameUz, nameRu: $nameRu, imgUrl: $imgUrl, order: $order)';
  }
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, id, createdAt, updatedAt, nameUz, nameRu, imgUrl, order);
...
abstract class _Datum implements Datum {
  const factory _Datum(
      ...
      @JsonKey(name: "order") required final int order}) = _$DatumImpl;
